"""
URL configuration for crm_saas project.
...
schema_view = get_schema_view(
    openapi.Info(
        title="CRM SaaS API",
        default_version='v1',
        description="Multi-tenant CRM SaaS API with database isolation",
        terms_of_service="https://www.google.com/policies/terms/",
        contact=openapi.Contact(email="contact@crm-saas.local"),
